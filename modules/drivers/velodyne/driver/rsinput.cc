...
cout << "[input] lidar ip is empty()!" << endl;
  } else {
    AINFO << "[input] device ip: " << this->dev_ip_;
cout << "[input] device ip: " << this->dev_ip_ << endl;
  }
...
cout << "[input] setsockopt error!" << endl;
    return -1;
  }
