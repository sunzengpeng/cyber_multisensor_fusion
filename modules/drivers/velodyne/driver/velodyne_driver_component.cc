...
cout << "Publish a scan" << endl;
    } else {
      AWARN << "device poll failed";
cout << "device poll failed" << endl;
    }
  }

  AERROR << "CompVelodyneDriver thread exit";
cout << "CompVelodyneDriver thread exit" << endl;
  runing_ = false;
}
